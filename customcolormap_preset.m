...
function J = customcolormap_preset(preset_name)
    ...
    switch(preset_name)
        ...
        case 'blue-yellow-red'
            J = customcolormap(linspace(0,1,11), flip({'#a60026','#d83023','#f66e44','#faac5d','#ffdf93','#ffffbd','#def4f9','#abd9e9','#73add2','#4873b5','#313691'}));
        case 'red-yellow-green'
            J = customcolormap(linspace(0,1,11), {'#a60126','#d7302a','#f36e43','#faac5d','#fedf8d','#fcffbf','#d7f08b','#a5d96b','#68bd60','#1a984e','#006936'});
        case 'blue-white-red'
            J = customcolormap([0 0.1 0.2 0.25 0.3 0.5 0.7 0.75 0.8 0.9 1], flip({'#68011d','#b5172f','#d75f4e','#f7a580','#fedbc9','#f5f9f3','#d5e2f0','#93c5dc','#4295c1','#2265ad','#062e61'}));
